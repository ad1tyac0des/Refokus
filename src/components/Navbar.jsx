            ...
            <div className="nleft flex items-center gap-20 z-10">
                ...
                <div className="nav-links flex items-center gap-14 ml-[4.5rem]">
                    {["Home", "Work", "Culture", "", "News"].map((navElement, index) => (
                        ...
                        >
                            {index === 1 && (
                                <span className="inline-block w-1 h-1 rounded-full bg-green-500 shadow-[0px_0px_0.55em_rgb(0,255,25)]"></span>
                            )}
                            {navElement.length === 0 ? (
                                <span className="inline-block w-px h-4 bg-zinc-600"></span>
                            ) : (
                                navElement
                            )}
                        </a>
